...
d3.json("/static/topojson/Ulsan.json", function(error, data) {
    var features = topojson.feature(data, data.objects.Ulsan).features;
...
d3.csv("/static/data/instadata/states/Ulsan.csv", function(data) {
  console.log(data);
