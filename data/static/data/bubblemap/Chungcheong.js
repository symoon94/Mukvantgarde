...
var projection = d3.geo.mercator()
    .center([126.8000, 36.5184])
    .scale(14000)
    .translate([width/3.1, height/1.8]);

var path = d3.geo.path().projection(projection);

d3.json("/static/topojson/Chungcheong.json", function(error, data) {
    var features = topojson.feature(data, data.objects["Chungcheong"]).features;
...
d3.csv("/static/data/instadata/states/Chungcheong.csv", function(data) {
  console.log(data);
