...
var projection = d3.geo.mercator()
    ...
    .scale(10000)
    .translate([width/1.8, height/3.2]);

var path = d3.geo.path().projection(projection);

d3.json("/static/topojson/Gyeongsang.json", function(error, data) {
    var features = topojson.feature(data, data.objects["Gyeongsang"]).features;
...
d3.csv("/static/data/instadata/states/Gyeongsang.csv", function(data) {
  console.log(data);
