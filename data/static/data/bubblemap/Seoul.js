...
d3.json("/static/topojson/Seoul.json", function(error, data) {
    var features = topojson.feature(data, data.objects.SeoulBound).features;
...
d3.csv("/static/data/instadata/states/Seoul.csv", function(data) {
  console.log(data);
