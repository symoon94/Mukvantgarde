...
d3.json("/static/topojson/Daegu.json", function(error, data) {
    var features = topojson.feature(data, data.objects.Daegu).features;
...
d3.csv("/static/data/instadata/states/Daegu.csv", function(data) {
  console.log(data);
