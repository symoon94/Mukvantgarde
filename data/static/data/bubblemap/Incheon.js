...
d3.json("/static/topojson/Incheon.json", function(error, data) {
    var features = topojson.feature(data, data.objects.Incheon).features;
...
d3.csv("/static/data/instadata/states/Incheon.csv", function(data) {
  console.log(data);
