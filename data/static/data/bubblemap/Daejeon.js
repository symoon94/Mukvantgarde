...
d3.json("/static/topojson/Daejeon.json", function(error, data) {
    var features = topojson.feature(data, data.objects.Daejeon).features;
...
d3.csv("/static/data/instadata/states/Daejeon.csv", function(data) {
  console.log(data);
