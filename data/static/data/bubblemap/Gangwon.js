...
var projection = d3.geo.mercator()
    .center([128.1555, 37.8228])
    .scale(14000)
    .translate([width/2.2, height/2]);

var path = d3.geo.path().projection(projection);

d3.json("/static/topojson/Gangwon-do.json", function(error, data) {
    var features = topojson.feature(data, data.objects["Gangwon-do"]).features;
...
d3.csv("/static/data/instadata/states/Gangwon-do.csv", function(data) {
  console.log(data);
