...
var projection = d3.geo.mercator()
    ...
    .scale(67000)
    .translate([width/2.05, height/1.6]);

var path = d3.geo.path().projection(projection);

d3.json("/static/topojson/Busan.json", function(error, data) {
    var features = topojson.feature(data, data.objects.Busan).features;
...
d3.csv("/static/data/instadata/states/Busan.csv", function(data) {
  console.log(data);
