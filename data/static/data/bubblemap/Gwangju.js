...
d3.json("/static/topojson/Gwangju.json", function(error, data) {
    var features = topojson.feature(data, data.objects.Gwangju).features;
...
d3.csv("/static/data/instadata/states/Gwangju.csv", function(data) {
  console.log(data);
