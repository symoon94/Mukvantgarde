...
var projection = d3.geo.mercator()
    .center([126.5895, 33.4651])
    .scale(38000)
    .translate([width/2, height/3]);

var path = d3.geo.path().projection(projection);

d3.json("/static/topojson/Jeju.json", function(error, data) {
    var features = topojson.feature(data, data.objects.Jeju).features;
...
d3.csv("/static/data/instadata/states/Jeju.csv", function(data) {
  console.log(data);
